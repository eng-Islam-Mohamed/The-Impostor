...
String localizedPackSubtitle(CategoryPack pack, SupportedLocale locale) {
  return switch (pack.id) {
    'countries' => _pickByLocale(locale, const {
      ...
      'es':
          'Elige entre países conocidos para rondas rápidas de farol y deducción.',
      'fr':
          'Choisissez parmi des pays connus pour des manches rapides de bluff.',
    ...
    'historical-people' => _pickByLocale(locale, const {
      ...
      'en':
          'Recognizable historical figures from different eras and civilizations.',
      'zh': '来自不同文明与时代、辨识度高的历史人物。',
      'hi':
          'विभिन्न सभ्यताओं और युगों के पहचाने जाने वाले ऐतिहासिक व्यक्तित्व।',
      'es':
          'Figuras históricas reconocibles de distintas épocas y civilizaciones.',
      'fr':
          'Des figures historiques connues de différentes époques et civilisations.',
      'bn': 'বিভিন্ন যুগ ও সভ্যতার পরিচিত ঐতিহাসিক ব্যক্তিত্ব।',
      'pt':
          'Figuras históricas reconhecíveis de diferentes eras e civilizações.',
